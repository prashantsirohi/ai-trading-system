# Archived Current Code Truth Map (2026-05-16 snapshot)

- **Purpose:** Preserve the May 2026 code-truth snapshot that was used during the earlier documentation rewrite.
...
- **Status:** Historical. This snapshot is not a current operating contract; use `docs/SYSTEM_GUIDE.md` and runtime code.
