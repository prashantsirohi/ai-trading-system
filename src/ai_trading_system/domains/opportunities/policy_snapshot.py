    ...
    *,
    ...
    return {
        ...
        CONVERGENCE_POLICY_VERSION: {
            ...
            "pattern_date_freshness_overrides_producer_fresh_label": True,
        ...
        CONVERGENCE_PERFORMANCE_POLICY_VERSION: {
            ...
            "market_calendar": "NSE_NIFTY_50_observed_sessions_no_symbol_fallback",
            "unsupported_exchange_policy": "insufficient_price_data",
            "missing_session_policy": "incomplete_never_shift_target",
            "open_fill_risk_starts_at_session_zero": True,
            "missing_anchor_policy": "defer_until_positive_finite_price",
            "window_requires_all_ten_sessions_matured_and_benchmark_complete": True,
            "aggregate_strata": ["policy_snapshot_id", "exchange"],
            "legacy_policy_outcomes": "retained_excluded_from_v2_maturation_and_aggregates",
            "confidence_bands": {
                "exploratory": [0, 29],
                "provisional": [30, 59],
                "moderate": [60, 119],
