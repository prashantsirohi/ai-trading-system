...
Usage:
    python -m ai_trading_system.domains.ranking.sector_dashboard
    python -m ai_trading_system.domains.ranking.sector_dashboard --local    # Skip Google Sheets update
"""
