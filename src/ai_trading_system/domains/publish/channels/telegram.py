...
def _load_quantstats():
    try:
        ...
        raise RuntimeError(
            "QuantStats support requires optional dependency 'quantstats' "
...
class TelegramReporter:
    ...
    async def send_metrics_async(
        ...
        metrics = [
            ...
            else "📉 <b>Sortino:</b> N/A",
            f"⚠️ <b>MaxDD:</b> {max_dd:.2%}"
            if isinstance(max_dd, (int, float))
            else "⚠️ <b>MaxDD:</b> N/A",
...
__all__ = ["TelegramReporter", "create_telegram_reporter", "format_telegram_rows"]
