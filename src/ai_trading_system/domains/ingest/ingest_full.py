...
Usage:
    python -m ai_trading_system.domains.ingest.ingest_full                    # Run one batch (respects daily limit)
    python -m ai_trading_system.domains.ingest.ingest_full --dry-run         # Show what would be ingested
    python -m ai_trading_system.domains.ingest.ingest_full --force           # Override daily limit check
"""
