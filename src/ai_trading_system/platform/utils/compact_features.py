...
Usage:
    python -m ai_trading_system.platform.utils.compact_features --help
    python -m ai_trading_system.platform.utils.compact_features --feature rsi --month 2026-03
    python -m ai_trading_system.platform.utils.compact_features --all
"""
