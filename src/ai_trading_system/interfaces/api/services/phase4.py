        ...
        for raw in coverage if isinstance(coverage, list) else []:
            ...
            result.append({
                **row, "position_cycle_id": cycle_id, "symbol_id": str(row.get("symbol_id") or ""), "exchange": str(row.get("exchange") or "NSE"),
                ...
                "evidence_complete": _bool(recon["investigator_evidence_complete"]) if "investigator_evidence_complete" in recon else _bool(row.get("investigator_evidence_complete") or row.get("evidence_complete")),
                "investigator_evidence_complete": _bool(recon["investigator_evidence_complete"]) if "investigator_evidence_complete" in recon else _bool(row.get("investigator_evidence_complete") or row.get("evidence_complete")),
                ...
                "route_data_covered": _bool(recon["route_data_covered"]) if "route_data_covered" in recon else None,
                "episode_attached": _bool(recon["episode_attached"]) if "episode_attached" in recon else None,
                "reconciliation_observed_session": recon.get("observed_session") or None,
                "reconciliation_schema_version": recon.get("reconciliation_schema_version") or None,
                "opportunity_episode_id": compat.get("candidate_id") or recon.get("candidate_id") or row.get("opportunity_episode_id"),
