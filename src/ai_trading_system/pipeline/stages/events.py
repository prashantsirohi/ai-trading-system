...
class EventsStage:
    ...
    def _snapshot_row(self, event, *, as_of_dt: datetime) -> dict[str, Any]:
        ...
        return {
            ...
            "risk_flags": getattr(event, "risk_flags", None) or _get_marker(event, "risk_flags_json"),
            "key_facts": getattr(event, "key_facts", None) or _get_marker(event, "key_facts_json"),
            "financials": getattr(event, "financials", None) or _get_marker(event, "financials_json"),
